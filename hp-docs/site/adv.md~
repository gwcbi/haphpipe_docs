...
#### Part 2H - Gather the needed initial input for each sample.
...
#### Part 3I - Gather all the individual module scripts into the final pipeline script
